...
# This is a modified version of the Open-AI Gym Bipedal walker:
#                                   simple 4-joints walker robot environment.
# "
...
# of points, more optimal agent will get better score.
#
# State consists of hull angle speed, angular velocity, horizontal speed,
# vertical speed, position of joints and joints angular speed, legs contact
# with ground, and 10 lidar rangefinder measurements to help to deal with the
# hardcore version. There's no coordinates in the state vector.
# Lidar is less useful in normal version, but it works.
#
# To solve the game you need to get 300 points in 1600 time steps.
# "
#
# Created by Oleg Klimov. Licensed on the same terms as the rest of OpenAI Gym.
# Edited by Daniel Nam, KC-ML2.
...
class ContactDetector(contactListener):
    ...
    def BeginContact(self, contact):
        if (self.env.hull == contact.fixtureA.body
...
class PyconWalker(gym.Env, EzPickle):
    metadata = {
    ...
    def step(self, action):
        ...
        # (normalized to get 300 on completion)
        shaping  = 130*pos[0]/SCALE
        # keep head straight, other than that and falling,
        # any behavior is unpunished
        ...
        for a in action:
            ...
            # normalized to about -50.0 using heuristic,
            # more optimal agent should spend less
        ...
        for obj in self.drawlist:
            for f in obj.fixtures:
                ...
                if type(f.shape) is circleShape:
                    ...
                    self.viewer.draw_circle(
                        f.shape.radius, 30, color=obj.color2,
